...
MopBop.default_options = {
    ...
    -- UI sizing - compact for just icons
    frameW = 150,
    frameH = 50,
...
function MopBop.CreateUIFrame()
    ...
    -- Background - make it transparent for clean look
    MopBop.UIFrame.texture = MopBop.UIFrame:CreateTexture();
    MopBop.UIFrame.texture:SetAllPoints(MopBop.UIFrame);
    MopBop.UIFrame.texture:SetTexture(0, 0, 0, 0); -- Completely transparent
    ...
    -- Spell icon containers - minimalist design
    MopBop.SpellIcons = {};
    local iconSize = 40;
    local spacing = 10;
    ...
    for i = 1, 3 do
        ...
        -- Border - thin white border like in the image
        ...
        MopBop.SpellIcons[i].border:SetTexture(1, 1, 1, 0.8); -- White border
